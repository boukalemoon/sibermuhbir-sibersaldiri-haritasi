...
export class ThreatMapComponent implements OnInit, OnDestroy {
  ...
  private turkishCountryNames: Record<string, string> = {
    ...
    'Serbia': 'Sırbistan', 'Singapore': 'Singapur', 'Slovakia': 'Slovakya',
    'South Africa': 'Güney Afrika', 'South Korea': 'Güney Kore',
    'Spain': 'İspanya', 'Sri Lanka': 'Sri Lanka', 'Sweden': 'İsveç',
    'Switzerland': 'İsviçre', 'Syria': 'Suriye', 'Taiwan': 'Tayvan',
    'Tajikistan': 'Tacikistan', 'Tanzania': 'Tanzanya', 'Thailand': 'Tayland',
    'Tunisia': 'Tunus', 'Turkey': 'Türkiye', 'Ukraine': 'Ukrayna',
    // Kritik düzeltmeler — COUNTRIES dizisiyle birebir eşleşmeli
    ...
    'Yemen': 'Yemen', 'Zimbabwe': 'Zimbabve', 'Zambia': 'Zambiya',
  };
